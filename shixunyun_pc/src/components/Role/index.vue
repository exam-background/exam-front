...
export default {
  ...
  methods: {
   addSysRole(){
    ...
    searchRole(){
      const data  = this.$qs.stringify({roleName:this.roleName})
      // alert(this.roleName)
      this.$axios
      .post(this.$location.getSysRoleList,data,{headers:{'Content-Type':'application/x-www-form-urlencoded'}})
      .then(response =>{
